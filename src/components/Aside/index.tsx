  ...
  return (
    ...
    ">
      <nav className="flex flex-col gap-6
        pt-4
      ">
        <a href="#" id="lista" className="flex flex-col content-center items-center
          text-sm
          text-gray-300
        ...
        <a href="#" id="lista" className="flex flex-col 
          items-center
          text-sm
          text-gray-300
          transition delay-150
        ...
        <a href="#" id="lista" className="flex flex-col text-sm items-center 
          text-sm 
          text-gray-300
          transition delay-150 
          hover:-translate-y-1 hover:text-blue-600 
        ...
        <a href="#" id="lista" className="flex flex-col text-center items-center
          text-sm 
          text-gray-300
          transition delay-150 
          hover:-translate-y-1 hover:text-blue-600 
