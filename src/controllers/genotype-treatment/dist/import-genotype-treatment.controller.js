...
var experiment_genotipe_controller_1 = require("../experiment_genotipe.controller");
...
var ImportGenotypeTreatmentController = /** @class */ (function () {
    ...
    ImportGenotypeTreatmentController.validate = function (idLog, _a) {
        ...
        return __awaiter(this, void 0, Promise, function () {
            var loteController, genotipoController, logImportController, genotypeTreatmentController, historyGenotypeTreatmentController, experimentController, experimentGenotipeController, responseIfError, _r, _s, _i, row, genetic_Data, genetic_ncc_connected, nccInTreatments, treatments, _t, _u, _v, column, experiments, status, status, status, status, _w, _x, _y, row, treatment, genotipo, lote, error_1, responseStringError, error_2;
            return __generator(this, function (_z) {
                switch (_z.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, genotipoController.getAll({ name_genotipo: spreadSheet[row][12],
                    ...
                    case 29:
                        ...
                        console.log("dgfd gdfg ", { idSafra: (_j = treatment[0]) === null || _j === void 0 ? void 0 : _j.safra.id,
                            ...
                            idTecnologia: (_m = treatment[0]) === null || _m === void 0 ? void 0 : _m.assay_list.tecnologia.id, nt: spreadSheet[row][8],
                            gli: spreadSheet[row][4],
                            npe: spreadSheet[row][10], idExperiment: (_o = treatment[0]) === null || _o === void 0 ? void 0 : _o.assay_list.experiment.id,
