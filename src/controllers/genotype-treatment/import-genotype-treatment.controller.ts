...
import {
  HistoryGenotypeTreatmentRepository
} from 'src/repository/genotype-treatment/history-genotype-tratment.repository';
    ...
    try {
      ...
      for (const row in spreadSheet) {
        ...
        if (row !== '0') { // LINHA COM TITULO DAS COLUNAS
          ...
          //     responseIfError[0]
          //       += `<li style="text-align:left"> A ${linhaStr}ª linha esta incorreta, o ensaio já foi sorteado </li> <br>`;
          //   }
          // }
          ...
          if (treatments.length === 0) {
            responseIfError[0]
              += `<li style="text-align:left"> A ${linhaStr}ª linha esta incorreta, o tratamento de genótipo não encontrado, as chaves para encontra-lo são (
            ...
            responseIfError[0]
              += `<li style="text-align:left"> A ${linhaStr}ª linha esta incorreta, o tratamento do genótipo já foi sorteado. </li> <br>`;
          }
