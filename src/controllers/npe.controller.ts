    ...
    async getAll(options: object | any) {
        ...
        try {
            ...
            if (options.paramSelect) {
                ...
                select = {id: true, local:{select:{name:true}}, safra:{select:{year:true}}, foco:{select:{name:true}}, epoca:{select:{name:true}}, tecnologia: {select:{name:true}}, type_assay: {select:{name:true}}, npei: true, npef: true, status: true};
            }
