...
export class ProfileController {
  ...
  async getAll(options: any) {
    ...
    try {
      ...
      handleError('Permissões de Perfil  controller', 'GetAll', error.message);
      throw new Error('[Controller] - GetAll Permissões de Perfil  erro');
    }
  }
  ...
  async getOne(id: number) {
    try {
      ...
      handleError('Permissões de Perfil  controller', 'GetOne', error.message);
      throw new Error('[Controller] - GetOne Permissões de Perfil  erro');
    }
  }
  ...
  async create(data: any) {
    try {
      ...
      handleError('Permissões de Perfil  controller', 'Create', error.message);
      throw new Error('[Controller] - Create Permissões de Perfil  erro');
    }
  }
  ...
  async update(data: any) {
    try {
      ...
      handleError('Permissões de Perfil  controller', 'Update', error.message);
      throw new Error('[Controller] - Update Permissões de Perfil  erro');
    }
  }
}
