  ...
  async listAll(options: any) {
    ...
    try {
      ...
      if (options.paramSelect) {
        ...
        select = { id: true, cod_quadra: true,  local_plantio: true, larg_q: true, comp_p: true, linha_p: true, comp_c: true, esquema: true, tiro_fixo: true, disparo_fixo: true, q: true, localPreparo: {select: {name_local_culture: true}}, Safra: { select: { safraName: true } }, status: true };
      }
