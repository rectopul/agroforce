...
export default function Listagem({
  ...
  const table = 'layout_quadra';
  const module_name = 'layout_quadra';
  const module_id = 5;
  ...
  const camposGerenciadosDefault = 'id,esquema,plantadeira,tiros,disparos,parcelas,status,action';
      ...
      render: (rowData: ILayoultProps) => (
        <div className="flex">
              ...
              <div className="h-7">
                <Button
                  ...
                  onClick={() => {
                    ...
                    setCookies('urlPage', 'quadraLayout');
                    router.push(
          ...
          <ButtonToogleConfirmation
            ...
            keyName="name"
            style={{
              display: !perm_can_do('/config/quadra/layout-quadra', 'disable')
                ? 'none'
                : '',
            }}
...
export const getServerSideProps: GetServerSideProps = async ({
  ...
  if (lastPageServer == undefined || lastPageServer == 'No' || req.cookies.urlPage !== 'quadraLayout') {
