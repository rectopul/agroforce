...
export default function Listagem({
  locais, itensPerPage, filterApplication, totalItems, pageBeforeEdit, filterBeforeEdit,
}: Idata) {
  ...
  const formik = useFormik<IFilter>({
    ...
    onSubmit: async ({
      ...
      const parametersFilter = `filterStatus=${filterStatus || 1}&filterNameLocalCulture=${filterNameLocalCulture}&filterLabel=${filterLabel}&filterMloc=${filterMloc}&filterAdress=${filterAdress}&filterLabelCountry=${filterLabelCountry}&filterLabelRegion=${filterLabelRegion}&filterNameLocality=${filterNameLocality}`;
