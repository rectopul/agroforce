...
export default function Listagem({
  ...
  const camposGerenciadosDefault = 'id,name_local_culture,label,mloc,adress,label_country,label_region,name_locality,action';
        ...
        <div className="h-7 flex">
          ...
          >
            <Button
              ...
              style={{ display: !perm_can_do('/config/local/local', 'edit') ? 'none' : '' }}
              onClick={() => {
