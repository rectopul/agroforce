...
export default function Listagem({ allItems, itensPerPage, filterAplication, totalItems, id_culture, id_safra, pageBeforeEdit, filterBeforeEdit }: Idata) {
	...
	const formik = useFormik<IFilter>({
		...
		onSubmit: async ({ filterStatus, filterSearch }) => {
			const parametersFilter = `filterStatus=${filterStatus ? filterStatus : 1}&filterSearch=${filterSearch}&id_culture=${id_culture}&id_safra=${id_safra}`;
	...
	function colums(camposGerenciados: any): any {
		const columnOrder: any = camposGerenciados.split(',');
