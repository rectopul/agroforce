...
export default function Listagem({
  allFocos, totalItems, itensPerPage, filterApplication, pageBeforeEdit, filterBeforeEdit,
}: IData) {
  ...
  const formik = useFormik<IFilter>({
    ...
    onSubmit: async ({ filterStatus, filterSearch }) => {
      const parametersFilter = `filterStatus=${filterStatus || 1}filterSearch=${filterSearch}&id_culture=${userLogado.userCulture.cultura_selecionada}`;
                  ...
                  >
                    ...
                    <div className="h-full flex items-center gap-2">
                      ...
                      <div className="h-12 flex items-center justify-center w-full">
                        <Button title="Exportar planilha de focos" icon={<RiFileExcel2Line size={20} />} bgColor="bg-blue-600" textColor="white" onClick={() => { downloadExcel(); }} />
                      </div>
                    </div>
                  </div>
                ),
