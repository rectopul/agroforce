...
function Listagem(_a) {
    ...
    function deleteItem(id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, services_1.npeService.deleted({ id: id, userId: userLogado.id })];
                    case 1:
        ...
        return {
            ...
            render: function (rowData) { return (React.createElement("div", { className: "h-7 flex" },
                ...
                rowData.status === 1 || rowData.status === 3 ? (React.createElement("div", null,
                    React.createElement(components_1.Button, { title: rowData.status === 3 ? '' : 'Ativo', icon: React.createElement(bs_1.BsTrashFill, { size: 14 }), onClick: function () { return deleteItem(rowData.id); }, bgColor: rowData.status === 3 ? 'bg-gray-400' : 'bg-red-600', textColor: "white", disabled: rowData.status === 3 }))) : (React.createElement("div", { className: "h-7 flex" },
                    React.createElement("div", { className: "h-7" }),
                    React.createElement("div", null,
                        React.createElement(components_1.Button, { title: "Inativo", icon: React.createElement(bs_1.BsTrashFill, { size: 14 }), onClick: function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                return [2 /*return*/, deleteItem(rowData.id)];
