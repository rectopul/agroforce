...
function Listagem(_a) {
  ...
  var allNpe = _a.allNpe,
      ...
      safraId = _a.safraId,
      idCulture = _a.idCulture;
  var TabsDropDowns = ITabs["default"].TabsDropDowns;
  var tabsDropDowns = TabsDropDowns();
  var router = router_1.useRouter(); // eslint-disable-next-line no-return-assign, no-param-reassign

  tabsDropDowns.map(function (tab) {
    return tab.titleTab === 'AMBIENTE' ? tab.statusTab = true : tab.statusTab = false;
  });
  ...
  var _b = react_1.useState(preferences.table_preferences),
      camposGerenciados = _b[0],
      setCamposGerenciados = _b[1];

  var _c = react_1.useState(allNpe),
      npe = _c[0],
      setNPE = _c[1];
  ...
  var _g = react_1.useState(filterApplication),
      filter = _g[0],
      setFilter = _g[1];

  var _h = react_1.useState(totalItems),
      itemsTotal = _h[0],
      setTotalItems = _h[1];

  var _j = react_1.useState(false),
      statusAccordion = _j[0],
      setStatusAccordion = _j[1];
  ...
  var _l = react_1.useState(function () {
    ...
    // },
    {
      ...
      defaultChecked: function defaultChecked() {
        return camposGerenciados.includes('safra');
      }
    }, {
      name: 'CamposGerenciados[]',
      title: 'Foco ',
      ...
      value: 'ensaio',
      defaultChecked: function defaultChecked() {
        return camposGerenciados.includes('ensaio');
      }
    }, {
      name: 'CamposGerenciados[]',
      title: 'Nome tec.',
      ...
      value: 'local',
      defaultChecked: function defaultChecked() {
        return camposGerenciados.includes('local');
      }
    }, {
      name: 'CamposGerenciados[]',
      title: 'Epoca ',
      value: 'epoca',
      defaultChecked: function defaultChecked() {
        return camposGerenciados.includes('epoca');
      }
    }, {
      name: 'CamposGerenciados[]',
      title: 'NPE Inicial ',
      value: 'npei',
      defaultChecked: function defaultChecked() {
        return camposGerenciados.includes('npei');
      }
    }, {
      name: 'CamposGerenciados[]',
      title: 'Prox NPE ',
      value: 'prox_npe',
      defaultChecked: function defaultChecked() {
        return camposGerenciados.includes('prox_npe');
      }
    }, {
      name: 'CamposGerenciados[]',
      title: 'Status',
      ...
      generatesProps = _l[0],
      setGeneratesProps = _l[1]; // const [orderBy, setOrderBy] = useState<string>('');
  ...
  var _o = react_1.useState(filterBeforeEdit),
      filtersParams = _o[0],
      setFiltersParams = _o[1]; // Set filter Parameter


  var _p = react_1.useState(orderByserver),
      orderBy = _p[0],
      setOrderBy = _p[1];

  var _q = react_1.useState(typeOrderServer),
      typeOrder = _q[0],
      setTypeOrder = _q[1];
  ...
  var formik = formik_1.useFormik({
    ...
    onSubmit: function onSubmit(_a) {
      var filterStatus = _a.filterStatus,
          filterLocal = _a.filterLocal,
          filterSafra = _a.filterSafra,
          filterFoco = _a.filterFoco,
          filterEnsaio = _a.filterEnsaio,
          filterTecnologia = _a.filterTecnologia,
          filterCodTecnologia = _a.filterCodTecnologia,
          filterEpoca = _a.filterEpoca,
          filterNPE = _a.filterNPE,
          filterNpeTo = _a.filterNpeTo,
          filterNpeFrom = _a.filterNpeFrom,
          filterNpeFinalTo = _a.filterNpeFinalTo,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , services_1.npeService.getAll(parametersFilter).then(function (response) {
  ...
  function idHeaderFactory() {
    return {
      ...
      render: function render() {
        return colorStar === '#eba417' ? React.createElement("div", {
          className: "h-9 flex"
        ...
        }, React.createElement(ai_1.AiTwotoneStar, {
          size: 20,
          color: "#eba417"
    ...
    return {
      ...
      render: function render(rowData) {
        return React.createElement("div", {
          ...
          className: "h-7"
        }, React.createElement(components_1.Button, {
          icon: React.createElement(bi_1.BiEdit, {
            size: 14
          }),
        ...
        }), rowData.status == 1 || rowData.status == 3 ? React.createElement("div", null, React.createElement(components_1.Button, {
          title: rowData.status == 3 ? '' : 'Ativo',
          icon: React.createElement(fa_1.FaRegThumbsUp, {
            size: 14
          }),
          onClick: function onClick() {
            return handleStatus(rowData.id, __assign({
          ...
          className: "h-7"
        }), React.createElement("div", null, React.createElement(components_1.Button, {
          title: "Inativo",
          icon: React.createElement(fa_1.FaRegThumbsDown, {
            size: 14
          }),
          onClick: function onClick() {
            return __awaiter(_this, void 0, void 0, function () {
              return __generator(this, function (_a) {
                return [2
                /*return*/
                , handleStatus(rowData.id, __assign({
                  status: rowData.status
                }, rowData))];
              });
            });
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 3:
            ...
            index_1 = npe.findIndex(function (npe) {
              return npe.id === idNPE;
            });
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4
            /*yield*/
            , services_1.npeService.getAll(filter).then(function (_a) {
              ...
              if (status === 200) {
                ...
                XLSX.utils.book_append_sheet(workBook, workSheet, 'npe'); // Buffer
  ...
  function filterFieldFactory(title, name) {
    return React.createElement("div", {
      className: "h-4 w-1/4 ml-2"
    }, React.createElement("label", {
      className: "block text-gray-900 text-sm font-bold mb-1"
    }, name), React.createElement(components_1.Input, {
      type: "text",
      placeholder: name,
  ...
  return React.createElement(React.Fragment, null, React.createElement(head_1["default"], null, React.createElement("title", null, "Listagem dos Ambientes")), React.createElement(components_1.Content, {
    contentHeader: tabsDropDowns,
    moduloActive: "config"
  }, React.createElement("main", {
    className: "h-full w-full\n          flex flex-col\n          items-start\n          gap-4\n        "
  }, React.createElement(components_1.AccordionFilter, {
    title: "Filtrar ambiente"
  }, React.createElement("div", {
    ...
    className: "h-6 w-1/4 ml-0"
  }, React.createElement("label", {
    className: "block text-gray-900 text-sm font-bold mb-1"
  }, "Status"), React.createElement(components_1.Select, {
    name: "filterStatus",
    onChange: formik.handleChange,
    defaultValue: filterStatusBeforeEdit[13],
    // defaultValue={checkValue('filterStatus')}
    values: filters.map(function (id) {
      return id;
    }),
    selected: "1"
  })), filterFieldFactory('filterSafra', 'Safra'), filterFieldFactory('filterFoco', 'Foco'), filterFieldFactory('filterEnsaio', 'Ensaio'), filterFieldFactory('filterCodTecnologia', 'Cód. Tec.'), filterFieldFactory('filterTecnologia', 'Nome Tec.'), filterFieldFactory('filterLocal', 'Lugar cultura'), filterFieldFactory('filterEpoca', 'Epoca'), React.createElement("div", {
    className: "h-6 w-1/3 ml-2"
  }, React.createElement("label", {
    className: "block text-gray-900 text-sm font-bold mb-1"
  }, "NPE Inicial"), React.createElement("div", {
    className: "flex"
    ...
    className: "block text-gray-900 text-sm font-bold mb-1"
  }, "Prox NPE"), React.createElement("div", {
    className: "flex"
  }, React.createElement(components_1.Input, {
    placeholder: "De",
    ...
    bgColor: "bg-blue-600",
    textColor: "white",
    icon: React.createElement(bi_1.BiFilterAlt, {
      size: 20
    })
  })))))), React.createElement("div", {
    className: "w-full h-full overflow-y-scroll"
  }, React.createElement(material_table_1["default"], {
    style: {
      background: '#f9fafb'
    },
    columns: columns,
    ...
    components: {
      Toolbar: function Toolbar() {
        return React.createElement("div", {
        ...
        }, "Total registrado:", ' ', itemsTotal), React.createElement("div", {
        ...
        }, React.createElement(react_beautiful_dnd_1.DragDropContext, {
          ...
          return React.createElement("ul", __assign({
            ...
            icon: React.createElement(io5_1.IoReloadSharp, {
              size: 20
            })
            ...
            return React.createElement(react_beautiful_dnd_1.Draggable, {
              ...
              return React.createElement("li", __assign({
                ref: provided.innerRef
              }, provided.draggableProps, provided.dragHandleProps), React.createElement(components_1.CheckBox, {
                name: generate.name,
          ...
          icon: React.createElement(ri_1.RiFileExcel2Line, {
            size: 20
          }),
          bgColor: "bg-blue-600",
          textColor: "white",
          ...
          title: "Configurar Importa\xE7\xE3o de Planilha",
          icon: React.createElement(ri_1.RiSettingsFill, {
            size: 20
          }),
          bgColor: "bg-blue-600",
          textColor: "white",
      ...
      Pagination: function Pagination(props) {
        return React.createElement("div", __assign({
          className: "flex\n                      h-20\n                      gap-2\n                      pr-2\n                      py-5\n                      bg-gray-50\n                    "
        }, props), React.createElement(components_1.Button, {
          onClick: function onClick() {
            return setCurrentPage(0);
          },
          bgColor: "bg-blue-600",
          textColor: "white",
          icon: React.createElement(md_1.MdFirstPage, {
            size: 18
          }),
          ...
          bgColor: "bg-blue-600",
          textColor: "white",
          icon: React.createElement(bi_1.BiLeftArrow, {
            size: 15
          }),
          disabled: currentPage <= 0
        }), Array(1).fill('').map(function (value, index) {
          return React.createElement(components_1.Button, {
            key: index,
            onClick: function onClick() {
          ...
          bgColor: "bg-blue-600",
          textColor: "white",
          icon: React.createElement(bi_1.BiRightArrow, {
            size: 15
          }),
          ...
          bgColor: "bg-blue-600",
          textColor: "white",
          icon: React.createElement(md_1.MdLastPage, {
            size: 18
          }),
          disabled: currentPage + 1 >= pages
        }));
    ...
    return __generator(this, function (_g) {
      switch (_g.label) {
        ...
        case 2:
          ...
          typeOrderServer = req.cookies.filterBeforeEditTypeOrder ? req.cookies.filterBeforeEditTypeOrder : '';
          orderByserver = req.cookies.filterBeforeEditOrderBy ? req.cookies.filterBeforeEditOrderBy : '';
          filterBeforeEdit = req.cookies.filterBeforeEdit ? req.cookies.filterBeforeEdit : "filterStatus=1&id_culture=" + idCulture + "&id_safra=" + safraId;
          publicRuntimeConfig = config_1["default"]().publicRuntimeConfig;
          baseUrl = publicRuntimeConfig.apiUrl + "/npe";
          filterApplication = req.cookies.filterBeforeEdit ? "" + req.cookies.filterBeforeEdit : "filterStatus=1&id_culture=" + idCulture + "&id_safra=" + safraId; // id_culture=${idCulture}&id_safra=${safraId}
          ...
          return [4
          /*yield*/
          , fetch(urlParameters.toString(), requestOptions).then(function (response) {
