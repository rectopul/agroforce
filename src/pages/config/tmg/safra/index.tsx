...
export default function Listagem({
  ...
  const formik = useFormik<IFilter>({
    ...
    onSubmit: async ({
      ...
      const parametersFilter = `filterStatus=${filterStatus || 2}&filterSafra=${filterSafra}&filterYearTo=${filterYearTo}&filterYearFrom=${filterYearFrom}&filterStartDate=${filterStartDate}&filterEndDate=${filterEndDate}&id_culture=${cultureId}`;
