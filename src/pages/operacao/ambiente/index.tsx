        ...
        <div className="h-7 flex">
          <div className="h-7">
            <Button
              ...
              textColor="white"
              title="Editar"
              style={{ display: !perm_can_do('/config/tmg/ambiente', 'edit') ? 'none' : '' }}
              onClick={() => {
          ...
          <ButtonDeleteConfirmation
            ...
            style={{ display: !perm_can_do('/config/tmg/ambiente', 'delete') ? 'none' : '' }}
            onPress={deleteItem}
                    ...
                    <div className="flex">
                      <div className="h-12">
                        <Button
                          ...
                          bgColor="bg-blue-600"
                          textColor="white"
                          style={{ display: !perm_can_do('/config/tmg/ambiente', 'import') ? 'none' : '' }}
                          onClick={() => {
                            window.open(
