...
function Listagem(_a) {
    ...
    var _m = react_1.useState([]), statusFilterSelected = _m[0], setStatusFilterSelected = _m[1];
    // const [orderBy, setOrderBy] = useState<string>('');
    var _o = react_1.useState(""), orderType = _o[0], setOrderType = _o[1];
    var _p = react_1.useState(""), arrowOrder = _p[0], setArrowOrder = _p[1];
    var router = router_1.useRouter();
    var _q = react_1.useState(false), statusAccordion = _q[0], setStatusAccordion = _q[1];
    // const take: number = itensPerPage;
    var _r = react_1.useState(itensPerPage), take = _r[0], setTake = _r[1];
    var total = itemsTotal <= 0 ? 1 : itemsTotal;
    var pages = Math.ceil(total / take);
    var _s = react_1.useState(orderByserver), orderBy = _s[0], setOrderBy = _s[1];
    var _t = react_1.useState(typeOrderServer), typeOrder = _t[0], setTypeOrder = _t[1];
    var pathExtra = "skip=" + currentPage * Number(take) + "&take=" + take + "&orderBy=" + orderBy + "&typeOrder=" + typeOrder;
    var _u = react_1.useState(false), isLoading = _u[0], setIsLoading = _u[1];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        setIsLoading(true);
                        return [4 /*yield*/, services_1.experimentGroupService.deleted(id)];
                    case 1:
...
exports.getServerSideProps = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var PreferencesControllers, itensPerPage, token, cultureId, idSafra, pageBeforeEdit, lastPageServer, filterBeforeEdit, filterApplication, typeOrderServer, orderByserver, publicRuntimeConfig, baseUrl, param, urlParameters, requestOptions, _b, _c, allExperimentGroup, _d, totalItems, safraId;
        var _e, _f, _g;
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 1: return [4 /*yield*/, ((_f = (_e = (_h.sent())) === null || _e === void 0 ? void 0 : _e.response[0]) === null || _f === void 0 ? void 0 : _f.itens_per_page)];
                case 2:
                    itensPerPage = (_g = (_h.sent())) !== null && _g !== void 0 ? _g : 10;
                    ...
                    return [4 /*yield*/, fetch(urlParameters.toString(), requestOptions).then(function (response) {
                            return response.json();
                        })];
                case 3:
                    _b = _h.sent(), _c = _b.response, allExperimentGroup = _c === void 0 ? [] : _c, _d = _b.total, totalItems = _d === void 0 ? 0 : _d;
                    safraId = idSafra;
                    return [2 /*return*/, {
                            props: {
