...
export default function Listagem({
  ...
  const formik = useFormik<IExperimentGroupFilter>({
    ...
    onSubmit: async ({
      ...
      }&filterQtdExpFrom=${filterQtdExpFrom
      }&filterTotalEtiqImprimirTo=${filterTotalEtiqImprimirTo
      }&filterTotalEtiqImprimirFrom=${filterTotalEtiqImprimirFrom
      }&filterTotalEtiqImpressasTo=${filterTotalEtiqImpressasTo
      }&filterTotalEtiqImpressasFrom=${filterTotalEtiqImpressasFrom
      }&filterTotalEtiqTo=${filterTotalEtiqTo
      }&filterTotalEtiqFrom=${filterTotalEtiqFrom}`;
