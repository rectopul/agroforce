...
function Listagem(_a) {
  ...
  var assaySelect = _a.assaySelect,
      genotypeSelect = _a.genotypeSelect,
      itensPerPage = _a.itensPerPage,
      filterApplication = _a.filterApplication,
      idSafra = _a.idSafra,
      filterBeforeEdit = _a.filterBeforeEdit,
      typeOrderServer = _a.typeOrderServer,
  ...
  var _d = react_1.useState(preferences.table_preferences),
      camposGerenciados = _d[0],
      setCamposGerenciados = _d[1];
  ...
  var _k = react_1.useState(filterBeforeEdit),
      filtersParams = _k[0],
      setFiltersParams = _k[1];

  var _l = react_1.useState(filterApplication),
      filter = _l[0],
      setFilter = _l[1];
  ...
  var _o = react_1.useState(function () {
    return [{
      ...
      defaultChecked: function defaultChecked() {
        return camposGerenciados.includes("foco");
      }
    }, {
      name: "CamposGerenciados[]",
      title: "Ensaio",
      value: "type_assay",
      defaultChecked: function defaultChecked() {
        return camposGerenciados.includes("type_assay");
      }
    }, {
      name: "CamposGerenciados[]",
      ...
      value: "tecnologia",
      defaultChecked: function defaultChecked() {
        return camposGerenciados.includes("tecnologia");
      }
    }, {
      name: "CamposGerenciados[]",
      title: "GLI",
      value: "gli",
      defaultChecked: function defaultChecked() {
        return camposGerenciados.includes("gli");
      }
    }, {
      name: "CamposGerenciados[]",
      title: "BGM",
      value: "bgm",
      defaultChecked: function defaultChecked() {
        return camposGerenciados.includes("bgm");
      }
    }, {
      name: "CamposGerenciados[]",
      title: "NT",
      ...
      defaultChecked: function defaultChecked() {
        return camposGerenciados.includes("treatments_number");
      }
    }, {
      name: "CamposGerenciados[]",
      title: "Status T",
      value: "status",
      defaultChecked: function defaultChecked() {
        return camposGerenciados.includes("status");
      }
    }, {
      name: "CamposGerenciados[]",
      ...
      value: "statusAssay",
      defaultChecked: function defaultChecked() {
        return camposGerenciados.includes("statusAssay");
      }
    }, {
      name: "CamposGerenciados[]",
      ...
      value: "genotipoName",
      defaultChecked: function defaultChecked() {
        return camposGerenciados.includes("genotipoName");
      }
    }, {
      name: "CamposGerenciados[]",
      title: "NCA",
      value: "nca",
      defaultChecked: function defaultChecked() {
        return camposGerenciados.includes("nca");
      }
    }];
  }),
      generatesProps = _o[0],
      setGeneratesProps = _o[1];
  ...
  var _p = react_1.useState(function () {
    return [{
      ...
      value: "importado",
      defaultChecked: function defaultChecked() {
        return camposGerenciados.includes("importado");
      }
    }, {
      name: "StatusCheckbox",
      title: "SORTEADO",
      value: "sorteado",
      defaultChecked: function defaultChecked() {
        return camposGerenciados.includes("sorteado");
      }
    }];
  }),
      statusFilter = _p[0],
      setStatusFilter = _p[1];

  var _q = react_1.useState([]),
      statusFilterSelected = _q[0],
      setStatusFilterSelected = _q[1]; // const [orderBy, setOrderBy] = useState<string>('');
  ...
  var _s = react_1.useState(false),
      statusAccordion = _s[0],
      setStatusAccordion = _s[1]; // const take: number = itensPerPage;


  var _t = react_1.useState(itensPerPage),
      take = _t[0],
      setTake = _t[1];
  ...
  var _v = react_1.useState(false),
      genotypeIsValid = _v[0],
      setGenotypeIsValid = _v[1];

  var _w = react_1.useState([]),
      rowsSelected = _w[0],
      setRowsSelected = _w[1];

  var _x = react_1.useState(""),
      arrowOrder = _x[0],
      setArrowOrder = _x[1];

  var _y = react_1.useState(orderByserver),
      orderBy = _y[0],
      setOrderBy = _y[1];

  var _z = react_1.useState(typeOrderServer),
      typeOrder = _z[0],
      setTypeOrder = _z[1];
  ...
  var formik = formik_1.useFormik({
    ...
    onSubmit: function onSubmit(_a) {
      var filterFoco = _a.filterFoco,
          filterTypeAssay = _a.filterTypeAssay,
          filterTechnology = _a.filterTechnology,
          filterGli = _a.filterGli,
          filterBgm = _a.filterBgm,
          filterTreatmentsNumber = _a.filterTreatmentsNumber,
          filterStatusAssay = _a.filterStatusAssay,
          filterGenotypeName = _a.filterGenotypeName,
          filterNca = _a.filterNca,
          filterBgmTo = _a.filterBgmTo,
          filterBgmFrom = _a.filterBgmFrom,
          filterNtTo = _a.filterNtTo,
          filterNtFrom = _a.filterNtFrom,
          filterStatusT = _a.filterStatusT,
          //filterStatus,
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            case 0:
              ...
              parametersFilter = "&filterFoco=" + filterFoco + "&filterTypeAssay=" + filterTypeAssay + "&filterTechnology=" + filterTechnology + "&filterGli=" + filterGli + "&filterBgm=" + filterBgm + "&filterTreatmentsNumber=" + filterTreatmentsNumber + "&filterStatus=" + filterStatus + "&filterStatusAssay=" + filterStatusAssay + "&filterGenotypeName=" + filterGenotypeName + "&filterNca=" + filterNca + "&id_safra=" + idSafra + "&filterBgmTo=" + filterBgmTo + "&filterBgmFrom=" + filterBgmFrom + "&filterNtTo=" + filterNtTo + "&filterNtFrom=" + filterNtFrom + "&filterStatusT=" + filterStatusT + "&filterCodTec=" + filterCodTec + "&status_experiment=" + "IMPORTADO"; // setFiltersParams(parametersFilter);
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , services_1.genotypeTreatmentService.getAll(parametersFilter).then(function (response) {
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            return [4
            /*yield*/
            , helpers_1.tableGlobalFunctions.handleOrderG(column, order, orderList)];
    ...
    return {
      title: react_1["default"].createElement("div", {
        ...
        onClick: function onClick() {
          return handleOrder(title, orderList);
        }
      }, name)),
      field: title,
      sorting: true,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            if (!(preferences.id === 0)) return [3
            /*break*/
            , 2];
            return [4
            /*yield*/
            , services_1.userPreferencesService.create({
          ...
          case 2:
            ...
            return [4
            /*yield*/
            , services_1.userPreferencesService.update({
              table_preferences: campos,
              id: preferences.id
            })];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4
            /*yield*/
            , services_1.genotypeTreatmentService.getAll(filter).then(function (_a) {
              ...
              if (status === 200) {
                ...
                XLSX.utils.book_append_sheet(workBook, workSheet, "Tratamentos"); // Buffer
  ...
  var replacementExcel = function replacementExcel() {
    return __awaiter(_this, void 0, Promise, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
  ...
  function filterFieldFactory(title, name) {
    return react_1["default"].createElement("div", {
      className: "h-7 w-1/2 ml-2"
    }, react_1["default"].createElement("label", {
      className: "block text-gray-900 text-sm font-bold mb-1"
    }, name), react_1["default"].createElement(components_1.Input, {
      type: "text",
      placeholder: name,
      id: title,
      name: title,
  ...
  function readExcel(value) {
    read_excel_file_1["default"](value[0]).then(function (rows) {
      services_1.importService.validate({
  ...
  function handleSubmit(event) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        if (genotypeButton) {
          checkedTreatments = rowsSelected.map(function (item) {
            return {
              id: item.id,
  ...
  function removeSameItems(data) {
    ...
    data === null || data === void 0 ? void 0 : data.map(function (i) {
      var item = newList === null || newList === void 0 ? void 0 : newList.filter(function (x) {
        return x.name == i.name;
      });
      if ((item === null || item === void 0 ? void 0 : item.length) <= 0) newList.push({
        id: i.id,
        name: i.name
      });
    });
  ...
  return react_1["default"].createElement(react_1["default"].Fragment, null, react_1["default"].createElement(head_1["default"], null, react_1["default"].createElement("title", null, "Listagem de gen\xF3tipos do ensaio")), react_1["default"].createElement(react_modal_1["default"], {
    isOpen: isOpenModal,
  ...
  }, react_1["default"].createElement(ri_1.RiCloseCircleFill, {
    size: 35,
    ...
    className: "mb-2 text-blue-600 text-xl font-medium"
  }, "A\xE7\xE3o"), react_1["default"].createElement("div", null, react_1["default"].createElement("div", {
    className: "border-l-8 border-l-blue-600 mt-4"
  }, react_1["default"].createElement("h2", {
    className: "mb-2 font-normal text-xl ml-2 text-gray-900"
  }, "Substituir")), react_1["default"].createElement("div", {
  ...
  }, "Nome do gen\xF3tipo"))), react_1["default"].createElement("div", {
    className: "flex items-center gap-2"
  }, react_1["default"].createElement("input", {
    type: "radio",
    name: "substituir",
    ...
    htmlFor: "nca",
    className: "font-normal text-base"
  }, "NCA"))), react_1["default"].createElement("div", null, react_1["default"].createElement("div", {
    className: "mb-2 text-blue-600 text-xl mt-2 font-medium"
  }, react_1["default"].createElement("h2", null, "Total selecionados: ", rowsSelected === null || rowsSelected === void 0 ? void 0 : rowsSelected.length)), react_1["default"].createElement("div", {
    className: "border-l-8 border-l-blue-600"
  }, react_1["default"].createElement("h2", {
    className: "mb-2 font-normal text-xl ml-2 text-gray-900 mt-6"
  }, "Importa Arquivo:")), react_1["default"].createElement("h2", null, "Excel"), react_1["default"].createElement(components_1.Input, {
    id: "import",
    type: "file",
  ...
  }, "Confirmar"))))), react_1["default"].createElement(components_1.Content, {
    contentHeader: tabsDropDowns,
    moduloActive: "listas"
  }, react_1["default"].createElement("main", {
    className: "h-full w-full\n          flex flex-col\n          items-start\n          gap-4\n        "
  }, react_1["default"].createElement(components_1.AccordionFilter, {
    title: "Filtrar gen\xF3tipos do ensaio"
  }, react_1["default"].createElement("div", {
    className: "w-full flex gap-2 z-1"
  }, react_1["default"].createElement("form", {
    className: "flex flex-col\n                  w-full\n                  items-center\n                  px-1\n                  bg-white\n                ",
    onSubmit: formik.handleSubmit
  }, react_1["default"].createElement("div", {
    className: "w-full h-full\n                  flex\n                  justify-center\n                  pb-6\n                "
  }, filterFieldFactory("filterFoco", "Foco"), filterFieldFactory("filterTypeAssay", "Ensaio"), react_1["default"].createElement("div", {
    className: "h-6 w-1/2 ml-2"
  }, react_1["default"].createElement("label", {
    className: "block text-gray-900 text-sm font-bold mb-1"
  }, "C\xF3d. Tecnologia"), react_1["default"].createElement("div", {
    className: "flex"
  }, react_1["default"].createElement(components_1.Input, {
    placeholder: "C\xF3d. Tecnologia",
    id: "filterCodTec",
    name: "filterCodTec",
    onChange: formik.handleChange
  }))), filterFieldFactory("filterTechnology", "Nome da tecnologia"), filterFieldFactory("filterGli", "GLI"), react_1["default"].createElement("div", {
    className: "h-6 w-1/2 ml-2"
  }, react_1["default"].createElement("label", {
    className: "block text-gray-900 text-sm font-bold mb-1"
  }, "BGM"), react_1["default"].createElement("div", {
    className: "flex"
  }, react_1["default"].createElement(components_1.Input, {
    placeholder: "De",
    id: "filterBgmFrom",
    ...
    className: "block text-gray-900 text-sm font-bold mb-1"
  }, "NT"), react_1["default"].createElement("div", {
    className: "flex"
  }, react_1["default"].createElement(components_1.Input, {
    placeholder: "De",
    id: "filterNtFrom",
    ...
    className: "block text-gray-900 text-sm font-bold mb-1"
  }, "Status T"), react_1["default"].createElement("div", {
    className: "flex"
  }, react_1["default"].createElement(components_1.Input, {
    ...
    className: "h-10 w-1/2 ml-2"
  }, react_1["default"].createElement("label", {
    className: "block text-gray-900 text-sm font-bold mb-1"
  }, "Status do Ensaio"), react_1["default"].createElement(components_1.SelectMultiple, {
    data: statusFilter.map(function (i) {
      return i.title;
    }),
    values: statusFilterSelected,
    onChange: function onChange(e) {
      return setStatusFilterSelected(e);
    }
  })), react_1["default"].createElement("div", {
    className: "h-7 w-1/2 ml-2"
  }, react_1["default"].createElement("label", {
    className: "block text-gray-900 text-sm font-bold mb-1"
  }, "Nome do gen\xF3tipo"), react_1["default"].createElement(components_1.SelectAutoComplete, {
    data: (_b = removeSameItems(genotypeSelect)) === null || _b === void 0 ? void 0 : _b.map(function (i) {
      return i.name;
    }),
  ...
  })), filterFieldFactory("filterNca", "NCA"), react_1["default"].createElement(components_1.FieldItemsPerPage, {
    selected: take,
    onChange: setTake
  }), react_1["default"].createElement("div", {
    style: {
    ...
    bgColor: "bg-blue-600",
    textColor: "white",
    icon: react_1["default"].createElement(bi_1.BiFilterAlt, {
      size: 20
    })
  })))))), react_1["default"].createElement("div", {
    className: "w-full h-full overflow-y-scroll"
  }, react_1["default"].createElement(material_table_1["default"], {
    tableRef: tableRef,
    style: {
      background: "#f9fafb"
    },
    ...
    options: {
      selection: true,
      selectionProps: function selectionProps(rowData) {
        return isOpenModal && {
          disabled: rowData
        };
      },
    ...
    components: {
      Toolbar: function Toolbar() {
        return react_1["default"].createElement("div", {
          ...
          bgColor: "bg-blue-600",
          icon: react_1["default"].createElement(ri_1.RiArrowUpDownLine, {
            size: 20
          })
        })), react_1["default"].createElement("strong", {
          className: "text-blue-600"
        }, "Total registrado: ", itemsTotal), react_1["default"].createElement("div", {
          className: "h-full flex items-center gap-2\n                    "
        }, react_1["default"].createElement("div", {
          className: "border-solid border-2 border-blue-600 rounded"
        }, react_1["default"].createElement("div", {
          className: "w-64"
        }, react_1["default"].createElement(components_1.AccordionFilter, {
          title: "Gerenciar Campos",
          grid: statusAccordion
        }, react_1["default"].createElement(react_beautiful_dnd_1.DragDropContext, {
          onDragEnd: handleOnDragEnd
        }, react_1["default"].createElement(react_beautiful_dnd_1.Droppable, {
          droppableId: "characters"
        }, function (provided) {
          return react_1["default"].createElement("ul", __assign({
            ...
            icon: react_1["default"].createElement(io5_1.IoReloadSharp, {
              size: 20
            })
          })), generatesProps.map(function (generate, index) {
            return react_1["default"].createElement(react_beautiful_dnd_1.Draggable, {
              key: index,
              ...
              return react_1["default"].createElement("li", __assign({
                ref: providers.innerRef
              }, providers.draggableProps, providers.dragHandleProps), react_1["default"].createElement(components_1.CheckBox, {
                name: generate.name,
                title: (_a = generate.title) === null || _a === void 0 ? void 0 : _a.toString(),
          ...
          title: "Exportar planilha para substitui\xE7\xE3o",
          icon: react_1["default"].createElement(bs_1.BsDownload, {
            size: 20
          }),
          bgColor: "bg-blue-600",
          textColor: "white",
          ...
          icon: react_1["default"].createElement(ri_1.RiFileExcel2Line, {
            size: 20
          }),
          bgColor: "bg-blue-600",
          textColor: "white",
      ...
      Pagination: function Pagination(props) {
        return react_1["default"].createElement("div", __assign({
          className: "flex\n                      h-20\n                      gap-2\n                      pr-2\n                      py-5\n                      bg-gray-50\n                    "
        }, props), react_1["default"].createElement(components_1.Button, {
          onClick: function onClick() {
            return setCurrentPage(0);
          },
          bgColor: "bg-blue-600",
          textColor: "white",
          icon: react_1["default"].createElement(md_1.MdFirstPage, {
            size: 18
          }),
          ...
          bgColor: "bg-blue-600",
          textColor: "white",
          icon: react_1["default"].createElement(bi_1.BiLeftArrow, {
            size: 15
          }),
          disabled: currentPage <= 0
        }), Array(1).fill("").map(function (value, index) {
          return react_1["default"].createElement(components_1.Button, {
            key: index,
            onClick: function onClick() {
          ...
          bgColor: "bg-blue-600",
          textColor: "white",
          icon: react_1["default"].createElement(bi_1.BiRightArrow, {
            size: 15
          }),
          ...
          bgColor: "bg-blue-600",
          textColor: "white",
          icon: react_1["default"].createElement(md_1.MdLastPage, {
            size: 18
          }),
          disabled: currentPage + 1 >= pages
        }));
    ...
    return __generator(this, function (_g) {
      switch (_g.label) {
        case 0:
          ...
          return [4
          /*yield*/
          , PreferencesControllers.getConfigGerais()];

        case 1:
          return [4
          /*yield*/
          , (_f = (_e = _g.sent()) === null || _e === void 0 ? void 0 : _e.response[0]) === null || _f === void 0 ? void 0 : _f.itens_per_page];
        ...
        case 2:
          ...
          if (lastPageServer == undefined || lastPageServer == "No") {
            ...
            cookies_next_1.removeCookies("pageBeforeEdit", {
              req: req,
              res: res
            });
            cookies_next_1.removeCookies("filterBeforeEditTypeOrder", {
              req: req,
              res: res
            });
            cookies_next_1.removeCookies("filterBeforeEditOrderBy", {
              req: req,
              res: res
            });
            cookies_next_1.removeCookies("lastPage", {
              req: req,
              res: res
            });
          }

          pageBeforeEdit = req.cookies.pageBeforeEdit ? req.cookies.pageBeforeEdit : 0;
          filterBeforeEdit = req.cookies.filterBeforeEdit ? req.cookies.filterBeforeEdit : "";
          token = req.cookies.token;
          idCulture = req.cookies.cultureId;
          idSafra = req.cookies.safraId;
          typeOrderServer = req.cookies.filterBeforeEditTypeOrder ? req.cookies.filterBeforeEditTypeOrder : "desc";
          orderByserver = req.cookies.filterBeforeEditOrderBy ? req.cookies.filterBeforeEditOrderBy : "assay_list.foco.name";
          ...
          filterApplication = req.cookies.filterBeforeEdit || "&id_culture=" + idCulture + "&id_safra=" + idSafra + "&status_experiment=" + "IMPORTADO";
          cookies_next_1.removeCookies("filterBeforeEdit", {
            req: req,
            res: res
          });
          ...
          return [4
          /*yield*/
          , fetch(urlParametersTreatment.toString(), requestOptions).then(function (response) {
        ...
        case 3:
          ...
          return [4
          /*yield*/
          , fetch(urlParametersAssay.toString() + "/?id_culture=" + idCulture + "&id_safra=" + idSafra, requestOptions).then(function (response) {
            return response.json();
          })];
