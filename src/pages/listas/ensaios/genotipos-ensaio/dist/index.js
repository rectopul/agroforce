                        ...
                        react_1["default"].createElement("form", { className: "flex flex-col\n                  w-full\n                  items-center\n                  px-1\n                  bg-white\n                ", onSubmit: formik.handleSubmit },
                            react_1["default"].createElement("div", { className: "w-full h-full\n                  flex\n                  justify-center\n                  pb-6\n                " },
                                ...
                                react_1["default"].createElement("div", { className: "h-10 w-1/2 ml-2" },
                                    react_1["default"].createElement("label", { className: "block text-gray-900 text-sm font-bold mb-1" }, "GLI"),
                                    react_1["default"].createElement(components_1.SelectAutoComplete, { data: assaySelect.map(function (i) { return i.name; }), 
                                ...
                                react_1["default"].createElement("div", { className: "h-6 w-1/2 ml-2" },
                                    ...
                                    react_1["default"].createElement("div", { className: "flex" },
                                        react_1["default"].createElement(components_1.Input, { placeholder: "De", id: "filterBgmFrom", name: "filterBgmFrom", onChange: formik.handleChange, defaultValue: checkValue("filterBgmFrom") }),
                                        react_1["default"].createElement(components_1.Input, { style: { marginLeft: 8 }, placeholder: "At\u00E9", id: "filterBgmTo", name: "filterBgmTo", onChange: formik.handleChange, defaultValue: checkValue("filterBgmTo") })))),
                            react_1["default"].createElement("div", { className: "w-full h-full\n                  flex\n                  justify-center\n                  pt-2\n                  pb-0\n                  " },
                                react_1["default"].createElement("div", { className: "h-6 w-1/2 ml-2" },
                                    ...
                                    react_1["default"].createElement("div", { className: "flex" },
                                        ...
                                        react_1["default"].createElement(components_1.Input, { style: { marginLeft: 8 }, placeholder: "At\u00E9", id: "filterNtTo", name: "filterNtTo", onChange: formik.handleChange, defaultValue: checkValue("filterNtTo") }))),
                                react_1["default"].createElement("div", { className: "h-6 w-1/2 ml-2" },
                                    react_1["default"].createElement("label", { className: "block text-gray-900 text-sm font-bold mb-1" }, "Status T"),
                                    react_1["default"].createElement("div", { className: "flex" },
                                        react_1["default"].createElement(components_1.Input, { placeholder: "Status T", id: "filterStatusT", name: "filterStatusT", onChange: formik.handleChange, defaultValue: checkValue("filterStatusT") }))),
                                react_1["default"].createElement("div", { className: "h-10 w-1/2 ml-2" },
