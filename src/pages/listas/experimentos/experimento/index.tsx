...
export default function Listagem({
  ...
  const [statusFilter, setStatusFilter] = useState<IGenerateProps[]>(() => [
    ...
    {
      name: "StatusCheckbox",
      title: "PARCIALMENTE ALOCADO",
      value: "PARCIALMENTE ALOCADO",
      defaultChecked: () => camposGerenciados.includes("PARCIALMENTE ALOCADO"),
    },
    {
      name: "StatusCheckbox",
      title: "TOTALMENTE ALOCADO",
      value: "TOTALMENTE ALOCADO",
      defaultChecked: () => camposGerenciados.includes("TOTALMENTE ALOCADO"),
    },
  ]);
  ...
  async function handlePagination(): Promise<void> {
    ...
    const { parametersFilter, currentPages } =
      await fetchWrapper.handlePaginationGlobal(
        currentPage,
        take,
        filtersParams
      );
