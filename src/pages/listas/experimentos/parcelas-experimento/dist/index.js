...
function Listagem(_a) {
    ...
    var _c = react_2.useState(false), isOpenModal = _c[0], setIsOpenModal = _c[1];
    ...
    var _d = react_2.useState(preferences.table_preferences), camposGerenciados = _d[0], setCamposGerenciados = _d[1];
    var _e = react_2.useState([]), treatments = _e[0], setTreatments = _e[1];
    var _f = react_2.useState(false), tableMessage = _f[0], setMessage = _f[1];
    var _g = react_2.useState(0), currentPage = _g[0], setCurrentPage = _g[1];
    var _h = react_2.useState(1), orderList = _h[0], setOrder = _h[1];
    var _j = react_2.useState(false), afterFilter = _j[0], setAfterFilter = _j[1];
    var _k = react_2.useState(filterBeforeEdit), filtersParams = _k[0], setFiltersParams = _k[1];
    var _l = react_2.useState(filterApplication), filter = _l[0], setFilter = _l[1];
    var _m = react_2.useState(0), itemsTotal = _m[0], setTotalItems = _m[1];
    var _o = react_2.useState(''), arrowOrder = _o[0], setArrowOrder = _o[1];
    ...
    ]; }), generatesProps = _p[0], setGeneratesProps = _p[1];
    var _q = react_2.useState(function () { return [
        {
            name: 'StatusCheckbox',
            title: 'IMPORTADO ',
            value: 'importado',
    ...
    ]; }), statusFilter = _q[0], setStatusFilter = _q[1];
    var _r = react_2.useState([]), statusFilterSelected = _r[0], setStatusFilterSelected = _r[1];
    // const [orderBy, setOrderBy] = useState<string>('');
    var _s = react_2.useState(''), orderType = _s[0], setOrderType = _s[1];
    var router = router_1.useRouter();
    var _t = react_2.useState(false), statusAccordion = _t[0], setStatusAccordion = _t[1];
    // const take: number = itensPerPage;
    var _u = react_2.useState(itensPerPage), take = _u[0], setTake = _u[1];
    var total = itemsTotal <= 0 ? 1 : itemsTotal;
    var pages = Math.ceil(total / take);
    var _v = react_2.useState(orderByserver), orderBy = _v[0], setOrderBy = _v[1]; // RR
    var _w = react_2.useState(typeOrderServer), typeOrder = _w[0], setTypeOrder = _w[1]; // RR
    ...
    var _x = react_2.useState(false), nccIsValid = _x[0], setNccIsValid = _x[1];
    var _y = react_2.useState(false), genotypeIsValid = _y[0], setGenotypeIsValid = _y[1];
    var _z = react_2.useState([]), rowsSelected = _z[0], setRowsSelected = _z[1];
    ...
    function orderColumns(columnsOrder) {
        ...
        Object.keys(columnOrder).forEach(function (item) {
            ...
            if (columnOrder[item] === 'culture') {
                ...
                // )
                headerTableFactory('Lugar plantio', 'experiment.local.name_local_culture'));
            }
    ...
    function removeSameItems(data) {
        ...
        var sortList = newList === null || newList === void 0 ? void 0 : newList.sort(function (a, b) { return (a.name < b.name ? -1 : a.name > b.name ? 1 : 0); });
        return sortList;
    }
                    ...
                    react_1["default"].createElement("div", null,
                        react_1["default"].createElement("div", { className: "mb-2 text-blue-600 text-xl mt-2 font-medium" },
                            react_1["default"].createElement("h2", null,
                                "Total selecionados:",
                                ' ', rowsSelected === null || rowsSelected === void 0 ? void 0 :
                                rowsSelected.length)),
                        ...
                        react_1["default"].createElement("form", { className: "flex flex-col\n                  w-full\n                  items-center\n                  px-1\n                  bg-white\n                ", onSubmit: formik.handleSubmit },
                            ...
                            react_1["default"].createElement("div", { className: "w-full h-full\n                  flex\n                  justify-center\n                  pt-2\n                  pb-3\n                  " },
                                ...
                                react_1["default"].createElement("div", { className: "h-7 w-1/2 ml-2" },
                                    ...
                                    react_1["default"].createElement(components_1.SelectAutoComplete, { data: (_b = removeSameItems(genotypeSelect)) === null || _b === void 0 ? void 0 : _b.map(function (i) { return i.name; }), value: checkValue('filterGenotypeName'), onChange: function (e) { return formik.setFieldValue('filterGenotypeName', e); } })),
